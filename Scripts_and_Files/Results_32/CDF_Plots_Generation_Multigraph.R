...
Input_Files_Multiplex <- read.table("Results_32/Multigraph/Multiplex_PPI_PATH_COEX.txt", header = TRUE, stringsAsFactors = FALSE)
# mean(Input_Files_Multiplex$Global_Ranking)
# [1] 2381.62
Input_Files_Multigraph <- read.table("Results_32/Multigraph/Merged_PPI_PATH_COEX.txt", header = TRUE, stringsAsFactors = FALSE)
