...
data.dir <- "Results_32/Heterogeneous/"
...
Input_Files_Monoplex <- read.table("Results_32/Heterogeneous/Monoplex.txt", header = TRUE, stringsAsFactors = FALSE)
# mean(Input_Files_Monoplex$Global_Ranking)
# [1] 3286.884

Input_Files_Multiplex <- read.table("Results_32/Heterogeneous/Multiplex.txt", header = TRUE, stringsAsFactors = FALSE)
# mean(Input_Files_Multiplex$Global_Ranking)
# [1] 2014.48

Input_Files_Heterogeneous <- read.table("Results_32/Heterogeneous/PPI_Heterogeneous.txt", header = TRUE, stringsAsFactors = FALSE)
# mean(Input_Files_Heterogeneous$Global_Ranking)
# [1] 1777.858

Input_Files_Multiplex_Heterogeneous <- read.table("Results_32/Heterogeneous/Multiplex_Heterogeneous.txt", header = TRUE, stringsAsFactors = FALSE)
...
ggdata <- data.frame(Multiplex_Heterogeneous)
